...
class ShiftableSelectorComponent(ModeSelectorComponent):
    ...
    def _set_device_buttons(self, on_off, lock):
    ...
    def update(self):
        ...
        if self.is_enabled():
            if self._mode_index == 0:
                ...
                self._set_transport_controls(self._select_buttons[0], self._select_buttons[1], self._select_buttons[2], self._select_buttons[3], self._tap_tempo_button)
                self._set_device_buttons(self._device_on_off_button, self._device_lock_button)
                ...
                self._set_transport_controls(None, None, None, None, None)
                self._set_device_buttons(None, None)
